pipeline {
    ...
    # run your container
    docker -H tcp://10.0.0.250:2375 run --rm -dit --name webapp2 --hostname webapp2 -p 5000:80 charan2135/pipelinetest2:${DOCKER_TAG}
fi'''             
          } 
        }
        ...
        stage('Check WebApp Reachablity') {
          steps {
            sh 'sleep 10s'
            sh 'curl http://ec2-3-109-186-180.ap-south-1.compute.amazonaws.com:5000'
          } 
        }
    }
}
